...
User.create!(email:'eduardo@leilaodogalpao.com.br', password: '@@l0ck3d0u7@@',cpf:'61882855345',admin:true)
...
Lot.create!(code: 'GAD459812', start_date:'11-05-2023',limit_date:'11-06-2023',min_value:1000,
    dif_value:500.00, user:user)

Lot.create!(code: 'BAT128290', start_date:'10-05-2023',limit_date:'11-06-2022',min_value:1000,
    dif_value:500.00, user:user)
